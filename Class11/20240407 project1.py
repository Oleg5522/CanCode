...
print('Hello, valuable client of our multinational corporation. In order to receive a monthly discount on our products, you need to register on our website. Please create a username and password.')
while True:
